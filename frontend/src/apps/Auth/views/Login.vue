  ...
  <div class="login-page">
    ...
    <div class="card login-card">
      ...
      <form @submit.prevent="handleLogin" class="login-form">
        ...
        <div style="margin-top: 1.2rem; text-align: center; font-size: 0.92rem; color: #475569;">
          Bạn chưa có tài khoản? <router-link :to="{ name: 'Register' }" style="color: #1a507a; font-weight: 600;">Đăng ký ngay</router-link>
        </div>
...
.form-group input { width: 100%; padding: 0.75rem; border: 1px solid #ddd; border-radius: 4px; outline: none; box-sizing: border-box; }
